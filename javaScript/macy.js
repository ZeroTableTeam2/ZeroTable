!function(t, n) {
    ...
    function f(t, n) {
        ...
        v(n, function(n) {
            ...
            isNaN(e) || (n.style.position = "absolute",
    ...
    var h = function t(n, e) {
        ...
        if (n && n.nodeName)
            return n;
        if (n = n.replace(/^\s*/, "").replace(/\s*$/, ""),
        e)
            return this.byCss(n, e);
        for (var r in this.selectors)
            if (e = r.split("/"),
            new RegExp(e[1],e[2]).test(n))
    ...
    y.prototype.on = function() {
        ...
        return !(!t || !n) && (Array.isArray(this.events[t]) || (this.events[t] = []),
    ...
    var g = function(t) {
      ...
      , O = function(t, n) {
        ...
        b(t) && t.margin && !b(t.margin) && (n.margin = {
            x: t.margin,
            y: t.margin
        }),
      ...
      , V = function(t) {
        ...
        return v(r, function(t) {
            n && (t.dataset.macyComplete = 0),
            t.style.width = o
        }),
        t.options.trueOrder ? (f(t, r, n, e),
        t.emit(t.constants.EVENT_RECALCULATED)) : (p(t, r, n, e),
